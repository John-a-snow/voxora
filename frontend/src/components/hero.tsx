export const Hero = () => {
    return (
        <header className="mb-16">
            <div className="flex justify-between items-start mb-8 border-b-2 border-brand-border pb-4">
                <div>
                    <h1 className="text-xl font-bold tracking-tight">EVERGREEN RAG</h1>
                ...
                <div className="text-right">
                    ...
                    <p className="text-xs uppercase tracking-widest font-bold mt-1 text-brand-primary">AI4BHARAT / MSMARCO-XI</p>
                </div>
            </div>
